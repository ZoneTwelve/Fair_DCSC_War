...
var alertTypes = ['error', 'error2', 'warning', 'info', 'success', 'input', 'prompt'];
    ...
    var _ret = (function () {
      ...
      switch (params.type) {
        ...
        case 'error':
		  ...
		  document.getElementsByClassName("animateErrorIcon")[0].onclick = function(){
			  location.href = "?level=8"
			  var pass = 'clickErrorIcon';
		  }
